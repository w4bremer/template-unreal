...
#include "TbRefInterfacesImportSettings.generated.h"

const FString TbRefInterfacesImportLocalBackendIdentifier = "Local";

class FSubsystemCollectionBase;
class ITbRefInterfacesImportCounter;

/**
 * Implements the settings for the TbRefInterfacesImport plugin.
 */
UCLASS(Config = Engine, DefaultConfig)
class TBREFINTERFACESIMPORTCORE_API UTbRefInterfacesImportSettings : public UObject
{
	GENERATED_BODY()

	UTbRefInterfacesImportSettings(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	static TScriptInterface<ITbRefInterfacesImportCounter> GetITbRefInterfacesImportCounterForLogging(FSubsystemCollectionBase& Collection);
