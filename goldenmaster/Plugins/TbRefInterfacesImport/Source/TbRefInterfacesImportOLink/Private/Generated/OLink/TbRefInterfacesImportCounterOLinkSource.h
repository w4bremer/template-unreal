...
DECLARE_LOG_CATEGORY_EXTERN(LogTbRefInterfacesImportCounterOLinkSource, Log, All);
/** @brief handles OLink network interactions specific to ITbRefInterfacesImportCounter */
class TbRefInterfacesImportCounterOLinkSource : public ApiGear::ObjectLink::IObjectSource
{
public:
	explicit TbRefInterfacesImportCounterOLinkSource();
	virtual ~TbRefInterfacesImportCounterOLinkSource() = default;
...
class TbRefInterfacesImportCounterOLinkSource
{
};
