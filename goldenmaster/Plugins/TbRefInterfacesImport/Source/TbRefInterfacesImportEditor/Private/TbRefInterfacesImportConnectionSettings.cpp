...
TSharedRef<IDetailCustomization> FTbRefInterfacesImportConnectionSettingsDetails::MakeInstance()
{
	return MakeShareable(new FTbRefInterfacesImportConnectionSettingsDetails);
}

TSharedRef<SWidget> FTbRefInterfacesImportConnectionSettingsDetails::MakeDefaultBackendServiceSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	...
	TSharedPtr<FText> LocalServiceName = TSharedPtr<FText>(new FText(FText::FromString(TbRefInterfacesImportLocalBackendIdentifier)));
...
void FTbRefInterfacesImportConnectionSettingsDetails::CustomizeTracerDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
TSharedRef<SWidget> FTbRefInterfacesImportConnectionSettingsDetails::MakeDefaultOLinkConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbRefInterfacesImportConnectionSettingsDetails::CustomizeOLinkDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
void FTbRefInterfacesImportConnectionSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
