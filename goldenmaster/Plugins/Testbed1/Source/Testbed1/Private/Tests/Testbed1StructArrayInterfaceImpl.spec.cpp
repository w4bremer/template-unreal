...
void UTestbed1StructArrayInterfaceImplSpec::Define()
{
	...
	It("Property.PropBool", [this]()
	{
		...
		ImplFixture->GetImplementation()->Execute_SetPropBool(ImplFixture->GetImplementation().GetObject(), TArray<FTestbed1StructBool>());
		TestEqual(TEXT("Getter should return the same value as set by the setter"), ImplFixture->GetImplementation()->Execute_GetPropBool(ImplFixture->GetImplementation().GetObject()), TArray<FTestbed1StructBool>());
	});

	It("Property.PropInt", [this]()
	{
		// Do implement test here
		ImplFixture->GetImplementation()->Execute_SetPropInt(ImplFixture->GetImplementation().GetObject(), TArray<FTestbed1StructInt>());
		TestEqual(TEXT("Getter should return the same value as set by the setter"), ImplFixture->GetImplementation()->Execute_GetPropInt(ImplFixture->GetImplementation().GetObject()), TArray<FTestbed1StructInt>());
	});

	It("Property.PropFloat", [this]()
	{
		// Do implement test here
		ImplFixture->GetImplementation()->Execute_SetPropFloat(ImplFixture->GetImplementation().GetObject(), TArray<FTestbed1StructFloat>());
		TestEqual(TEXT("Getter should return the same value as set by the setter"), ImplFixture->GetImplementation()->Execute_GetPropFloat(ImplFixture->GetImplementation().GetObject()), TArray<FTestbed1StructFloat>());
	});

	It("Property.PropString", [this]()
	{
		// Do implement test here
		ImplFixture->GetImplementation()->Execute_SetPropString(ImplFixture->GetImplementation().GetObject(), TArray<FTestbed1StructString>());
		TestEqual(TEXT("Getter should return the same value as set by the setter"), ImplFixture->GetImplementation()->Execute_GetPropString(ImplFixture->GetImplementation().GetObject()), TArray<FTestbed1StructString>());
	});
