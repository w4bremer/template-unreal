...
void Testbed1StructArrayInterfaceOLinkSource::setBackendService(TScriptInterface<ITestbed1StructArrayInterfaceInterface> InService)
{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("Cannot set backend service to %s - interface Testbed1StructArrayInterface is not fully implemented"), *InService.GetObject()->GetName());
		return;
	}
...
void Testbed1StructArrayInterfaceOLinkSource::setOLinkHost(TSoftObjectPtr<UUnrealOLinkHost> InHost)
{
	Host = InHost.Get();
}
