...
class UTestbed1StructInterfaceSimulationClient : public UObject, public ITestbed1StructInterfaceInterface
{
	GENERATED_BODY()
public:
	explicit UTestbed1StructInterfaceSimulationClient();
	virtual ~UTestbed1StructInterfaceSimulationClient();
