...
void UTestbed2ManyParamInterfaceOLinkAdapter::setBackendService(TScriptInterface<ITestbed2ManyParamInterfaceInterface> InService)
{
	...
	if (BackendService != nullptr)
	{
		...
		BackendSignals->OnProp1ChangedBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp1Changed);
		BackendSignals->OnProp2ChangedBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp2Changed);
		BackendSignals->OnProp3ChangedBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp3Changed);
		BackendSignals->OnProp4ChangedBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp4Changed);
		BackendSignals->OnSig1SignalBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig1);
		BackendSignals->OnSig2SignalBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig2);
		BackendSignals->OnSig3SignalBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig3);
		BackendSignals->OnSig4SignalBP.RemoveDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig4);
	}
	...
	BackendSignals->OnProp1ChangedBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp1Changed);
	BackendSignals->OnProp2ChangedBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp2Changed);
	BackendSignals->OnProp3ChangedBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp3Changed);
	BackendSignals->OnProp4ChangedBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnProp4Changed);
	BackendSignals->OnSig1SignalBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig1);
	BackendSignals->OnSig2SignalBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig2);
	BackendSignals->OnSig3SignalBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig3);
	BackendSignals->OnSig4SignalBP.AddDynamic(this, &UTestbed2ManyParamInterfaceOLinkAdapter::OnSig4);
