...
#include "Generated/api/Testbed2NoPropertyInterfaceInterface.h"
#include "Testbed2NoPropertyInterface.generated.h"

UCLASS(BlueprintType, Blueprintable)
class TESTBED2_API UTestbed2NoPropertyInterface : public UObject, public ITestbed2NoPropertyInterfaceInterface
{
	GENERATED_BODY()
public:
	virtual ~UTestbed2NoPropertyInterface();
