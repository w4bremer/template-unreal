...
#include "Testbed2NestedStruct2InterfaceSimulationClient.h"
...
UTestbed2NestedStruct2InterfaceSimulationClient::UTestbed2NestedStruct2InterfaceSimulationClient()
	: ITestbed2NestedStruct2InterfaceInterface()
{
}

void UTestbed2NestedStruct2InterfaceSimulationClient::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UTestbed2NestedStruct2InterfaceSimulationClient::Deinitialize()
{
	Super::Deinitialize();
...
void UTestbed2NestedStruct2InterfaceSimulationClient::BroadcastSig1_Implementation(const FTestbed2NestedStruct1& Param1)
{
	Sig1Signal.Broadcast(Param1);
}

FTestbed2NestedStruct2InterfaceSig1Delegate& UTestbed2NestedStruct2InterfaceSimulationClient::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

void UTestbed2NestedStruct2InterfaceSimulationClient::BroadcastSig2_Implementation(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2)
{
	Sig2Signal.Broadcast(Param1, Param2);
}

FTestbed2NestedStruct2InterfaceSig2Delegate& UTestbed2NestedStruct2InterfaceSimulationClient::GetSig2SignalDelegate()
{
	return Sig2Signal;
}

void UTestbed2NestedStruct2InterfaceSimulationClient::BroadcastProp1Changed_Implementation(const FTestbed2NestedStruct1& InProp1)
{
	Prop1 = InProp1;
	Prop1Changed.Broadcast(InProp1);
}

FTestbed2NestedStruct1 UTestbed2NestedStruct2InterfaceSimulationClient::GetProp1_Implementation() const
{
	return Prop1;
}

void UTestbed2NestedStruct2InterfaceSimulationClient::SetProp1_Implementation(const FTestbed2NestedStruct1& InProp1)
{
	Params params;
...
FTestbed2NestedStruct2InterfaceProp1ChangedDelegate& UTestbed2NestedStruct2InterfaceSimulationClient::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}

void UTestbed2NestedStruct2InterfaceSimulationClient::BroadcastProp2Changed_Implementation(const FTestbed2NestedStruct2& InProp2)
{
	Prop2 = InProp2;
	Prop2Changed.Broadcast(InProp2);
}

FTestbed2NestedStruct2 UTestbed2NestedStruct2InterfaceSimulationClient::GetProp2_Implementation() const
{
	return Prop2;
}

void UTestbed2NestedStruct2InterfaceSimulationClient::SetProp2_Implementation(const FTestbed2NestedStruct2& InProp2)
{
	Params params;
...
FTestbed2NestedStruct2InterfaceProp2ChangedDelegate& UTestbed2NestedStruct2InterfaceSimulationClient::GetProp2ChangedDelegate()
{
	return Prop2Changed;
}

FTestbed2NestedStruct1 UTestbed2NestedStruct2InterfaceSimulationClient::Func1_Implementation(const FTestbed2NestedStruct1& Param1)
{
	Params params;
...
FTestbed2NestedStruct1 UTestbed2NestedStruct2InterfaceSimulationClient::Func2_Implementation(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2)
{
	Params params;
	params["param1"] = Param1;
