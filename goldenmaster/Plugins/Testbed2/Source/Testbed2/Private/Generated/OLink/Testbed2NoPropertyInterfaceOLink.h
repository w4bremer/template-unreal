...
#include "Testbed2NoPropertyInterfaceOLink.generated.h"

UCLASS(BlueprintType)
class TESTBED2_API UTestbed2NoPropertyInterfaceOLinkService : public UObject, public ITestbed2NoPropertyInterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
	explicit UTestbed2NoPropertyInterfaceOLinkService();
	virtual ~UTestbed2NoPropertyInterfaceOLinkService();
