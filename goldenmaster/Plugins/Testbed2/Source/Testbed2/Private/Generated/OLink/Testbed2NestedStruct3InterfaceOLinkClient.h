...
class TESTBED2_API UTestbed2NestedStruct3InterfaceOLinkClient : public UGameInstanceSubsystem, public ITestbed2NestedStruct3InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
