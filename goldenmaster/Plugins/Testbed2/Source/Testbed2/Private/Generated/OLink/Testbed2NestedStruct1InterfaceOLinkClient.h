...
class TESTBED2_API UTestbed2NestedStruct1InterfaceOLinkClient : public UGameInstanceSubsystem, public ITestbed2NestedStruct1InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
