...
std::string UTestbed2NestedStruct2InterfaceOLinkClient::olinkObjectName()
{
	return "testbed2.NestedStruct2Interface";
}

void UTestbed2NestedStruct2InterfaceOLinkClient::olinkOnSignal(std::string name, nlohmann::json args)
{
...
void UTestbed2NestedStruct2InterfaceOLinkClient::olinkOnPropertyChanged(std::string name, nlohmann::json value)
{
	std::string path = Name::pathFromName(name);
	applyState({{path, value}});
}

void UTestbed2NestedStruct2InterfaceOLinkClient::olinkOnInit(std::string name, nlohmann::json props, IClientNode* node)
{
	m_isReady = true;
	m_node = node;
	applyState(props);
...
void UTestbed2NestedStruct2InterfaceOLinkClient::olinkOnRelease()
{
	m_isReady = false;
	m_node = nullptr;
}
