...
BEGIN_DEFINE_SPEC(UTestbed2NestedStruct2InterfaceImplementationSpec, "Testbed2.NestedStruct2Interface.Implementation",
...
END_DEFINE_SPEC(UTestbed2NestedStruct2InterfaceImplementationSpec);

void UTestbed2NestedStruct2InterfaceImplementationSpec::Define()
{
	BeforeEach([this]()
	{
		...
		testImplementation = GameInstanceFixture->GetGameInstance()->GetSubsystem<UTestbed2NestedStruct2Interface>();
