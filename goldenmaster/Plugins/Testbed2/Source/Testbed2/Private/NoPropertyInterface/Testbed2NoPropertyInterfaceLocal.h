...
#include "Testbed2NoPropertyInterfaceLocal.generated.h"

UCLASS(BlueprintType, Blueprintable, DisplayName = "Testbed2NoPropertyInterface")
class TESTBED2_API UTestbed2NoPropertyInterfaceLocalService : public UObject, public ITestbed2NoPropertyInterfaceInterface
{
	GENERATED_BODY()
public:
