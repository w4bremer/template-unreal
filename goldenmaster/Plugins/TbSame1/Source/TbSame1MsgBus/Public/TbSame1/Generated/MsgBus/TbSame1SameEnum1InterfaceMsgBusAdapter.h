...
class TBSAME1MSGBUS_API UTbSame1SameEnum1InterfaceMsgBusAdapter : public UGameInstanceSubsystem
{
	GENERATED_BODY()
public:
	...
	void _setBackendService(TScriptInterface<ITbSame1SameEnum1Interface> InService);
