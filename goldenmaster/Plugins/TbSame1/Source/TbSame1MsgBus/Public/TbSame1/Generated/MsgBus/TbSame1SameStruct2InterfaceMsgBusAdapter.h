...
class TBSAME1MSGBUS_API UTbSame1SameStruct2InterfaceMsgBusAdapter : public UGameInstanceSubsystem
{
	GENERATED_BODY()
public:
	...
	void _setBackendService(TScriptInterface<ITbSame1SameStruct2Interface> InService);
