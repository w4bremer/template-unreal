...
void UTbSame1SameEnum1InterfaceMsgBusAdapter::_setBackendService(TScriptInterface<ITbSame1SameEnum1InterfaceInterface> InService)
{
	...
	if (BackendService != nullptr)
	{
		...
		BackendSignals->OnProp1ChangedBP.RemoveDynamic(this, &UTbSame1SameEnum1InterfaceMsgBusAdapter::OnProp1Changed);
		BackendSignals->OnSig1SignalBP.RemoveDynamic(this, &UTbSame1SameEnum1InterfaceMsgBusAdapter::OnSig1);
	}
	...
	BackendSignals->OnProp1ChangedBP.AddDynamic(this, &UTbSame1SameEnum1InterfaceMsgBusAdapter::OnProp1Changed);
	BackendSignals->OnSig1SignalBP.AddDynamic(this, &UTbSame1SameEnum1InterfaceMsgBusAdapter::OnSig1);
}
