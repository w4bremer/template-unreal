...
void UTbSame1SameEnum2InterfaceMsgBusAdapter::_StartListening()
{
	...
	TbSame1SameEnum2InterfaceMsgBusEndpoint = FMessageEndpoint::Builder("ApiGear/TbSame1/SameEnum2Interface/Service")
		.Handling<FTbSame1SameEnum2InterfaceDiscoveryMessage>(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnNewClientDiscovered)
...
void UTbSame1SameEnum2InterfaceMsgBusAdapter::_setBackendService(TScriptInterface<ITbSame1SameEnum2InterfaceInterface> InService)
{
	...
	if (BackendService != nullptr)
	{
		...
		BackendSignals->OnProp1ChangedBP.RemoveDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnProp1Changed);
		BackendSignals->OnProp2ChangedBP.RemoveDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnProp2Changed);
		BackendSignals->OnSig1SignalBP.RemoveDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnSig1);
		BackendSignals->OnSig2SignalBP.RemoveDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnSig2);
	}
	...
	BackendSignals->OnProp1ChangedBP.AddDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnProp1Changed);
	BackendSignals->OnProp2ChangedBP.AddDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnProp2Changed);
	BackendSignals->OnSig1SignalBP.AddDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnSig1);
	BackendSignals->OnSig2SignalBP.AddDynamic(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnSig2);
}

void UTbSame1SameEnum2InterfaceMsgBusAdapter::OnNewClientDiscovered(const FTbSame1SameEnum2InterfaceDiscoveryMessage& /*InMessage*/, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
