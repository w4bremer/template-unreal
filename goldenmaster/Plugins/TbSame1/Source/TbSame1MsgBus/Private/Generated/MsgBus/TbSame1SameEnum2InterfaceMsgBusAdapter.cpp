...
void UTbSame1SameEnum2InterfaceMsgBusAdapter::_setBackendService(TScriptInterface<ITbSame1SameEnum2InterfaceInterface> InService)
{
	...
	OnProp1ChangedHandle = BackendSignals->OnProp1Changed.AddUObject(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnProp1Changed);
	OnProp2ChangedHandle = BackendSignals->OnProp2Changed.AddUObject(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnProp2Changed);
	OnSig1SignalHandle = BackendSignals->OnSig1Signal.AddUObject(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnSig1);
	OnSig2SignalHandle = BackendSignals->OnSig2Signal.AddUObject(this, &UTbSame1SameEnum2InterfaceMsgBusAdapter::OnSig2);
}
