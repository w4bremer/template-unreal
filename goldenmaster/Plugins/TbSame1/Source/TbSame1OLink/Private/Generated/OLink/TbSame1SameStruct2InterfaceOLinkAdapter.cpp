...
void UTbSame1SameStruct2InterfaceOLinkAdapter::setBackendService(TScriptInterface<ITbSame1SameStruct2Interface> InService)
{
	...
	OnProp1ChangedHandle = BackendSignals->OnProp1Changed.AddUObject(this, &UTbSame1SameStruct2InterfaceOLinkAdapter::OnProp1Changed);
	OnProp2ChangedHandle = BackendSignals->OnProp2Changed.AddUObject(this, &UTbSame1SameStruct2InterfaceOLinkAdapter::OnProp2Changed);
	OnSig1SignalHandle = BackendSignals->OnSig1Signal.AddUObject(this, &UTbSame1SameStruct2InterfaceOLinkAdapter::OnSig1);
	OnSig2SignalHandle = BackendSignals->OnSig2Signal.AddUObject(this, &UTbSame1SameStruct2InterfaceOLinkAdapter::OnSig2);
