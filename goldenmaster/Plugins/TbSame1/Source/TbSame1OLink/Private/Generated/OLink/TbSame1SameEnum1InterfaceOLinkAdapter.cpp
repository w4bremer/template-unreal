...
void UTbSame1SameEnum1InterfaceOLinkAdapter::setBackendService(TScriptInterface<ITbSame1SameEnum1InterfaceInterface> InService)
{
	...
	if (BackendService != nullptr)
	{
		...
		BackendSignals->OnProp1ChangedBP.RemoveDynamic(this, &UTbSame1SameEnum1InterfaceOLinkAdapter::OnProp1Changed);
		BackendSignals->OnSig1SignalBP.RemoveDynamic(this, &UTbSame1SameEnum1InterfaceOLinkAdapter::OnSig1);
	}
	...
	BackendSignals->OnProp1ChangedBP.AddDynamic(this, &UTbSame1SameEnum1InterfaceOLinkAdapter::OnProp1Changed);
	BackendSignals->OnSig1SignalBP.AddDynamic(this, &UTbSame1SameEnum1InterfaceOLinkAdapter::OnSig1);
