...
public:
    ...
    void Func1(UObject* WorldContextObject, struct FLatentActionInfo LatentInfo, FTbSame1Struct1& Result,const FTbSame1Struct1& Param1);
    FTbSame1Struct1 Func1(const FTbSame1Struct1& Param1) override;

	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface", meta=(Latent, LatentInfo="LatentInfo", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"))
    void Func2(UObject* WorldContextObject, struct FLatentActionInfo LatentInfo, FTbSame1Struct1& Result,const FTbSame1Struct1& Param1, const FTbSame1Struct2& Param2);
