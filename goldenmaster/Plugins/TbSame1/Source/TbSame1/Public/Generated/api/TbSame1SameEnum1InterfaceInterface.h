...
public:
	// signals
	UFUNCTION(Category = "ApiGear|TbSame1|SameEnum1Interface|Signals")
...
protected:
	// signals
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSame1|SameEnum1Interface|Signals", meta = (BlueprintProtected = "true"))
