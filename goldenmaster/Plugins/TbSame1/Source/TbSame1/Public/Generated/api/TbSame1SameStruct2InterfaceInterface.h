...
public:
	// signals
	UFUNCTION(Category = "ApiGear|TbSame1|SameStruct2Interface|Signals")
...
protected:
	// signals
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", meta = (BlueprintProtected = "true"))
