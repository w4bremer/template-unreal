...
public:
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "Sig1 Signal")
	FTbSame1SameStruct2InterfaceSig1Delegate OnSig1Signal;

	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "Sig2 Signal")
	FTbSame1SameStruct2InterfaceSig2Delegate OnSig2Signal;

	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "Property Prop1 Changed")
	FTbSame1SameStruct2InterfaceProp1ChangedDelegate OnProp1Changed;

	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "Property Prop2 Changed")
