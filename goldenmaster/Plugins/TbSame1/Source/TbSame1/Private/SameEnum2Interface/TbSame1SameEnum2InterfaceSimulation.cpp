...
ETbSame1Enum2 SimulationService::GetProp2_Implementation() const
{
	return Prop2;
}

void SimulationService::SetProp2_Implementation(const ETbSame1Enum2& InProp2)
{
	Params params;
...
ETbSame1Enum1 SimulationService::Func2_Implementation(const ETbSame1Enum1& Param1, const ETbSame1Enum2& Param2)
{
	Params params;
	params["param1"] = Param1;
