...
FTbSame1SameStruct1InterfaceSig1Delegate& OLinkService::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

FTbSame1Struct1 OLinkService::GetProp1() const
{
	return Prop1;
}

void OLinkService::SetProp1(const FTbSame1Struct1& InProp1)
{
	if (!m_node)
	{
		return;
...
FTbSame1SameStruct1InterfaceProp1ChangedDelegate& OLinkService::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}
