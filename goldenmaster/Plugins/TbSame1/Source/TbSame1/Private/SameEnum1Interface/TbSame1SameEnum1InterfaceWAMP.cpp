...
#include "TbSame1SameEnum1InterfaceWAMP.h"
	...
	, Prop1(ETbSame1Enum1::VALUE1)
{
	...
	UnrealWamp::instance()->doSubscribe("tb.same1.SameEnum1Interface", SameEnum1InterfaceStateChangedFunc);
	...
	UnrealWamp::instance()->doCall("tb.same1.SameEnum1Interface._get", Arguments(), ArgumentsKw(), GetSameEnum1InterfaceStateFunc);
	...
	UnrealWamp::instance()->doSubscribe("tb.same1.SameEnum1Interface.sig1", sig1Func);
}

WAMPService::~WAMPService()
{
	UnrealWamp::instance()->doUnSubscribe("tb.same1.SameEnum1Interface");
	UnrealWamp::instance()->doUnSubscribe("tb.same1.SameEnum1Interface.sig1");
}

FTbSame1SameEnum1InterfaceSig1Delegate& WAMPService::GetSig1SignalDelegate()
{
	return Sig1Signal;
}
...
void WAMPService::SetProp1(const ETbSame1Enum1& InProp1)
{
	...
	UnrealWamp::instance()->doCall("tb.same1.SameEnum1Interface._set", Arguments(), fields_);
}

FTbSame1SameEnum1InterfaceProp1ChangedDelegate& WAMPService::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}
...
ETbSame1Enum1 WAMPService::Func1(const ETbSame1Enum1& Param1)
{
	...
	Async(EAsyncExecution::Thread,
		[Param1, &Promise]()
		{
			...
			UnrealWamp::instance()->doCall("tb.same1.SameEnum1Interface.func1", {Param1}, ArgumentsKw(), GetSameEnum1InterfaceStateFunc);
		});
