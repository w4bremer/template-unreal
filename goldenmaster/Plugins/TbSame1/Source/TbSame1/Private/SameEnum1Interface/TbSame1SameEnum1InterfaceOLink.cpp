...
FTbSame1SameEnum1InterfaceSig1Delegate& OLinkService::GetSig1SignalDelegate()
{
    return Sig1Signal;
}
...
FTbSame1SameEnum1InterfaceProp1ChangedDelegate& OLinkService::GetProp1ChangedDelegate()
{
    return Prop1Changed;
}
