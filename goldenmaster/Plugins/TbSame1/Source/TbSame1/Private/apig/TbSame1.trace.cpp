...
void TbSame1SameStruct1InterfaceTracer::capture_state(ITbSame1SameStruct1InterfaceInterface* obj)
{
...
void TbSame1SameStruct2InterfaceTracer::capture_state(ITbSame1SameStruct2InterfaceInterface* obj)
{
    nlohmann::json fields_;
    fields_["prop1"] = obj->GetProp1();
...
void TbSame1SameEnum1InterfaceTracer::capture_state(ITbSame1SameEnum1InterfaceInterface* obj)
{
    nlohmann::json fields_;
    fields_["prop1"] = obj->GetProp1();
...
void TbSame1SameEnum1InterfaceTracer::trace_signalSig1(const ETbSame1Enum1& Param1)
{
    nlohmann::json fields_;
    fields_["param1"] = Param1;
...
void TbSame1SameEnum1InterfaceTracer::trace_callFunc1(const ETbSame1Enum1& Param1)
{
    nlohmann::json fields_;
    fields_["param1"] = Param1;
...
void TbSame1SameEnum2InterfaceTracer::capture_state(ITbSame1SameEnum2InterfaceInterface* obj)
{
    nlohmann::json fields_;
    fields_["prop1"] = obj->GetProp1();
    fields_["prop2"] = obj->GetProp2();
...
void TbSame1SameEnum2InterfaceTracer::trace_callSetProp2(const ETbSame1Enum2& InProp2)
{
    nlohmann::json fields_;
    fields_["prop2"] = InProp2;
    Tracer::instance()->call("tb.same1/SameEnum2Interface#_set", fields_);
...
void TbSame1SameEnum2InterfaceTracer::trace_signalSig1(const ETbSame1Enum1& Param1)
{
    nlohmann::json fields_;
    fields_["param1"] = Param1;
...
void TbSame1SameEnum2InterfaceTracer::trace_signalSig2(const ETbSame1Enum1& Param1, const ETbSame1Enum2& Param2)
{
    nlohmann::json fields_;
    fields_["param1"] = Param1;
    fields_["param2"] = Param2;
...
void TbSame1SameEnum2InterfaceTracer::trace_callFunc1(const ETbSame1Enum1& Param1)
{
    nlohmann::json fields_;
    fields_["param1"] = Param1;
...
void TbSame1SameEnum2InterfaceTracer::trace_callFunc2(const ETbSame1Enum1& Param1, const ETbSame1Enum2& Param2)
{
    nlohmann::json fields_;
    fields_["param1"] = Param1;
    fields_["param2"] = Param2;
