...
#include "TbSame1SameStruct1InterfaceSimulationClient.h"
...
UTbSame1SameStruct1InterfaceSimulationClient::UTbSame1SameStruct1InterfaceSimulationClient()
	: ITbSame1SameStruct1InterfaceInterface()
{
}

void UTbSame1SameStruct1InterfaceSimulationClient::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UTbSame1SameStruct1InterfaceSimulationClient::Deinitialize()
{
	Super::Deinitialize();
...
void UTbSame1SameStruct1InterfaceSimulationClient::BroadcastSig1_Implementation(const FTbSame1Struct1& Param1)
{
	Sig1Signal.Broadcast(Param1);
}

FTbSame1SameStruct1InterfaceSig1Delegate& UTbSame1SameStruct1InterfaceSimulationClient::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

void UTbSame1SameStruct1InterfaceSimulationClient::BroadcastProp1Changed_Implementation(const FTbSame1Struct1& InProp1)
{
	Prop1 = InProp1;
	Prop1Changed.Broadcast(InProp1);
}

FTbSame1Struct1 UTbSame1SameStruct1InterfaceSimulationClient::GetProp1_Implementation() const
{
	return Prop1;
}

void UTbSame1SameStruct1InterfaceSimulationClient::SetProp1_Implementation(const FTbSame1Struct1& InProp1)
{
	Params params;
...
FTbSame1SameStruct1InterfaceProp1ChangedDelegate& UTbSame1SameStruct1InterfaceSimulationClient::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}

FTbSame1Struct1 UTbSame1SameStruct1InterfaceSimulationClient::Func1_Implementation(const FTbSame1Struct1& Param1)
{
	Params params;
