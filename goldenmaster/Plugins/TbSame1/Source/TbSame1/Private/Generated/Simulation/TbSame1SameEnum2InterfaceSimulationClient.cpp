...
#include "TbSame1SameEnum2InterfaceSimulationClient.h"
...
UTbSame1SameEnum2InterfaceSimulationClient::UTbSame1SameEnum2InterfaceSimulationClient()
	: ITbSame1SameEnum2InterfaceInterface()
{
}

void UTbSame1SameEnum2InterfaceSimulationClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	NotifyRequestFunc sig2Func = [this](NotifyRequestArg arg)
	{
		...
		{
			Execute_BroadcastSig2(this, fields["param1"].get<ETbSame1Enum1>(), fields["param2"].get<ETbSame1Enum2>());
		}
	};
	if (AGCM != nullptr)
	{
...
void UTbSame1SameEnum2InterfaceSimulationClient::Deinitialize()
{
	Super::Deinitialize();
...
void UTbSame1SameEnum2InterfaceSimulationClient::BroadcastSig1_Implementation(const ETbSame1Enum1& Param1)
{
	Sig1Signal.Broadcast(Param1);
}

FTbSame1SameEnum2InterfaceSig1Delegate& UTbSame1SameEnum2InterfaceSimulationClient::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

void UTbSame1SameEnum2InterfaceSimulationClient::BroadcastSig2_Implementation(const ETbSame1Enum1& Param1, const ETbSame1Enum2& Param2)
{
	Sig2Signal.Broadcast(Param1, Param2);
}

FTbSame1SameEnum2InterfaceSig2Delegate& UTbSame1SameEnum2InterfaceSimulationClient::GetSig2SignalDelegate()
{
	return Sig2Signal;
}

void UTbSame1SameEnum2InterfaceSimulationClient::BroadcastProp1Changed_Implementation(const ETbSame1Enum1& InProp1)
{
	Prop1 = InProp1;
	Prop1Changed.Broadcast(InProp1);
}

ETbSame1Enum1 UTbSame1SameEnum2InterfaceSimulationClient::GetProp1_Implementation() const
{
	return Prop1;
}

void UTbSame1SameEnum2InterfaceSimulationClient::SetProp1_Implementation(const ETbSame1Enum1& InProp1)
{
	Params params;
...
FTbSame1SameEnum2InterfaceProp1ChangedDelegate& UTbSame1SameEnum2InterfaceSimulationClient::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}

void UTbSame1SameEnum2InterfaceSimulationClient::BroadcastProp2Changed_Implementation(const ETbSame1Enum2& InProp2)
{
	Prop2 = InProp2;
	Prop2Changed.Broadcast(InProp2);
}

ETbSame1Enum2 UTbSame1SameEnum2InterfaceSimulationClient::GetProp2_Implementation() const
{
	return Prop2;
}

void UTbSame1SameEnum2InterfaceSimulationClient::SetProp2_Implementation(const ETbSame1Enum2& InProp2)
{
	Params params;
...
FTbSame1SameEnum2InterfaceProp2ChangedDelegate& UTbSame1SameEnum2InterfaceSimulationClient::GetProp2ChangedDelegate()
{
	return Prop2Changed;
}

ETbSame1Enum1 UTbSame1SameEnum2InterfaceSimulationClient::Func1_Implementation(const ETbSame1Enum1& Param1)
{
	Params params;
...
ETbSame1Enum1 UTbSame1SameEnum2InterfaceSimulationClient::Func2_Implementation(const ETbSame1Enum1& Param1, const ETbSame1Enum2& Param2)
{
	Params params;
	params["param1"] = Param1;
