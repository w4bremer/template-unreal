...
std::string UTbSame1SameStruct2InterfaceOLinkClient::olinkObjectName()
{
	return "tb.same1.SameStruct2Interface";
}

void UTbSame1SameStruct2InterfaceOLinkClient::olinkOnSignal(std::string name, nlohmann::json args)
{
...
void UTbSame1SameStruct2InterfaceOLinkClient::olinkOnPropertyChanged(std::string name, nlohmann::json value)
{
	std::string path = Name::pathFromName(name);
	applyState({{path, value}});
}

void UTbSame1SameStruct2InterfaceOLinkClient::olinkOnInit(std::string name, nlohmann::json props, IClientNode* node)
{
	m_isReady = true;
	m_node = node;
	applyState(props);
...
void UTbSame1SameStruct2InterfaceOLinkClient::olinkOnRelease()
{
	m_isReady = false;
	m_node = nullptr;
}
