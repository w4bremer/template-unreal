...
class TBSAME1_API UTbSame1SameStruct2InterfaceOLinkClient : public UObject, public ITbSame1SameStruct2InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
