...
class TBSAME1_API UTbSame1SameStruct2InterfaceOLinkClient : public UGameInstanceSubsystem, public ITbSame1SameStruct2InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
