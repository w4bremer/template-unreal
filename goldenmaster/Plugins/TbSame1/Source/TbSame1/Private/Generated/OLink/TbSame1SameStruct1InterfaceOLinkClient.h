...
class TBSAME1_API UTbSame1SameStruct1InterfaceOLinkClient : public UGameInstanceSubsystem, public ITbSame1SameStruct1InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
