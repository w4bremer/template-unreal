...
#include "TbRefInterfacesSettings.generated.h"

const FString TbRefInterfacesLocalBackendIdentifier = "Local";
...
/**
 * Implements the settings for the TbRefInterfaces plugin.
 */
UCLASS(Config = Engine, DefaultConfig)
class TBREFINTERFACESCORE_API UTbRefInterfacesSettings : public UObject
{
	GENERATED_BODY()

	UTbRefInterfacesSettings(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	static TScriptInterface<ITbRefInterfacesSimpleLocalIf> GetITbRefInterfacesSimpleLocalIfForLogging(FSubsystemCollectionBase& Collection);
	static TScriptInterface<ITbRefInterfacesParentIf> GetITbRefInterfacesParentIfForLogging(FSubsystemCollectionBase& Collection);
