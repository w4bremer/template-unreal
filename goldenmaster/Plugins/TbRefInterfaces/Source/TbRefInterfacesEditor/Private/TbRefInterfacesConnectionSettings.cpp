...
TSharedRef<IDetailCustomization> FTbRefInterfacesConnectionSettingsDetails::MakeInstance()
{
	return MakeShareable(new FTbRefInterfacesConnectionSettingsDetails);
}

TSharedRef<SWidget> FTbRefInterfacesConnectionSettingsDetails::MakeDefaultBackendServiceSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	...
	TSharedPtr<FText> LocalServiceName = TSharedPtr<FText>(new FText(FText::FromString(TbRefInterfacesLocalBackendIdentifier)));
...
void FTbRefInterfacesConnectionSettingsDetails::CustomizeTracerDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
TSharedRef<SWidget> FTbRefInterfacesConnectionSettingsDetails::MakeDefaultOLinkConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbRefInterfacesConnectionSettingsDetails::CustomizeOLinkDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
void FTbRefInterfacesConnectionSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
