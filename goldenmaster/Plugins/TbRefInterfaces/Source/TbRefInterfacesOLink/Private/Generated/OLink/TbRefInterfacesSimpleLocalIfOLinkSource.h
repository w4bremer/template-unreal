...
DECLARE_LOG_CATEGORY_EXTERN(LogTbRefInterfacesSimpleLocalIfOLinkSource, Log, All);
/** @brief handles OLink network interactions specific to ITbRefInterfacesSimpleLocalIf */
class TbRefInterfacesSimpleLocalIfOLinkSource : public ApiGear::ObjectLink::IObjectSource
{
public:
	explicit TbRefInterfacesSimpleLocalIfOLinkSource();
	virtual ~TbRefInterfacesSimpleLocalIfOLinkSource() = default;
...
class TbRefInterfacesSimpleLocalIfOLinkSource
{
};
