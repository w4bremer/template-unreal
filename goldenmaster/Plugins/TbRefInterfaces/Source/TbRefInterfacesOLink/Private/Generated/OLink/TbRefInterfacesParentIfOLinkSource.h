...
DECLARE_LOG_CATEGORY_EXTERN(LogTbRefInterfacesParentIfOLinkSource, Log, All);
/** @brief handles OLink network interactions specific to ITbRefInterfacesParentIf */
class TbRefInterfacesParentIfOLinkSource : public ApiGear::ObjectLink::IObjectSource
{
public:
	explicit TbRefInterfacesParentIfOLinkSource();
	virtual ~TbRefInterfacesParentIfOLinkSource() = default;
...
class TbRefInterfacesParentIfOLinkSource
{
};
