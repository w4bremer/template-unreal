...
public:
	...
	using FTbSame2SameStruct1InterfaceFactoryFunction = TFunction<TScriptInterface<ITbSame2SameStruct1Interface>(FSubsystemCollectionBase& Collection)>;
	using FTbSame2SameStruct2InterfaceFactoryFunction = TFunction<TScriptInterface<ITbSame2SameStruct2Interface>(FSubsystemCollectionBase& Collection)>;
	using FTbSame2SameEnum1InterfaceFactoryFunction = TFunction<TScriptInterface<ITbSame2SameEnum1Interface>(FSubsystemCollectionBase& Collection)>;
	using FTbSame2SameEnum2InterfaceFactoryFunction = TFunction<TScriptInterface<ITbSame2SameEnum2Interface>(FSubsystemCollectionBase& Collection)>;
	...
	static TScriptInterface<ITbSame2SameStruct1Interface> GetTbSame2SameStruct1InterfaceImplementation(FString UniqueImplementationIdentifier, FSubsystemCollectionBase& Collection);
	static TScriptInterface<ITbSame2SameStruct2Interface> GetTbSame2SameStruct2InterfaceImplementation(FString UniqueImplementationIdentifier, FSubsystemCollectionBase& Collection);
	static TScriptInterface<ITbSame2SameEnum1Interface> GetTbSame2SameEnum1InterfaceImplementation(FString UniqueImplementationIdentifier, FSubsystemCollectionBase& Collection);
	static TScriptInterface<ITbSame2SameEnum2Interface> GetTbSame2SameEnum2InterfaceImplementation(FString UniqueImplementationIdentifier, FSubsystemCollectionBase& Collection);
