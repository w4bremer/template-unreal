...
#include "TbSame2SameStruct1InterfaceSimulationClient.h"
...
UTbSame2SameStruct1InterfaceSimulationClient::UTbSame2SameStruct1InterfaceSimulationClient()
	: ITbSame2SameStruct1InterfaceInterface()
{
}

void UTbSame2SameStruct1InterfaceSimulationClient::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UTbSame2SameStruct1InterfaceSimulationClient::Deinitialize()
{
	Super::Deinitialize();
...
void UTbSame2SameStruct1InterfaceSimulationClient::BroadcastSig1_Implementation(const FTbSame2Struct1& Param1)
{
	Sig1Signal.Broadcast(Param1);
}

FTbSame2SameStruct1InterfaceSig1Delegate& UTbSame2SameStruct1InterfaceSimulationClient::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

void UTbSame2SameStruct1InterfaceSimulationClient::BroadcastProp1Changed_Implementation(const FTbSame2Struct1& InProp1)
{
	Prop1 = InProp1;
	Prop1Changed.Broadcast(InProp1);
}

FTbSame2Struct1 UTbSame2SameStruct1InterfaceSimulationClient::GetProp1_Implementation() const
{
	return Prop1;
}

void UTbSame2SameStruct1InterfaceSimulationClient::SetProp1_Implementation(const FTbSame2Struct1& InProp1)
{
	Params params;
...
FTbSame2SameStruct1InterfaceProp1ChangedDelegate& UTbSame2SameStruct1InterfaceSimulationClient::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}

FTbSame2Struct1 UTbSame2SameStruct1InterfaceSimulationClient::Func1_Implementation(const FTbSame2Struct1& Param1)
{
	Params params;
