...
void TbSame2SameStruct2InterfaceOLinkSource::setBackendService(TScriptInterface<ITbSame2SameStruct2InterfaceInterface> InService)
{
	...
	{
		UE_LOG(LogTbSame2SameStruct2InterfaceOLinkSource, Error, TEXT("Cannot set backend service to %s - interface TbSame2SameStruct2Interface is not fully implemented"), *InService.GetObject()->GetName());
		return;
	}
...
void TbSame2SameStruct2InterfaceOLinkSource::setOLinkHost(TSoftObjectPtr<UUnrealOLinkHost> InHost)
{
	Host = InHost.Get();
}
