...
class TBSAME2_API UTbSame2SameStruct2InterfaceOLinkClient : public UObject, public ITbSame2SameStruct2InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
