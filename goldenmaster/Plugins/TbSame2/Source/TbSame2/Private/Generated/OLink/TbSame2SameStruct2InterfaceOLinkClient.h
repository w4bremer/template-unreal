...
class TBSAME2_API UTbSame2SameStruct2InterfaceOLinkClient : public UGameInstanceSubsystem, public ITbSame2SameStruct2InterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
