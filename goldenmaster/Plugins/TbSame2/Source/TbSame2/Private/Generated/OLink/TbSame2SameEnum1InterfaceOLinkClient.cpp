...
#include "TbSame2SameEnum1InterfaceOLinkClient.h"
...
void UTbSame2SameEnum1InterfaceOLinkClient::BroadcastSig1_Implementation(const ETbSame2Enum1& Param1)
{
...
void UTbSame2SameEnum1InterfaceOLinkClient::BroadcastProp1Changed_Implementation(const ETbSame2Enum1& InProp1)
{
	Prop1 = InProp1;
...
void UTbSame2SameEnum1InterfaceOLinkClient::SetProp1_Implementation(const ETbSame2Enum1& InProp1)
{
	if (!m_node)
	{
		return;
...
ETbSame2Enum1 UTbSame2SameEnum1InterfaceOLinkClient::Func1_Implementation(const ETbSame2Enum1& Param1)
{
	if (!m_node)
	{
...
std::string UTbSame2SameEnum1InterfaceOLinkClient::olinkObjectName()
{
	return "tb.same2.SameEnum1Interface";
}

void UTbSame2SameEnum1InterfaceOLinkClient::olinkOnSignal(std::string name, nlohmann::json args)
{
...
void UTbSame2SameEnum1InterfaceOLinkClient::olinkOnPropertyChanged(std::string name, nlohmann::json value)
{
	std::string path = Name::pathFromName(name);
	applyState({{path, value}});
}

void UTbSame2SameEnum1InterfaceOLinkClient::olinkOnInit(std::string name, nlohmann::json props, IClientNode* node)
{
	m_isReady = true;
	m_node = node;
	applyState(props);
...
void UTbSame2SameEnum1InterfaceOLinkClient::olinkOnRelease()
{
	m_isReady = false;
	m_node = nullptr;
}
