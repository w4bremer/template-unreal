...
#include "TbSame2SameStruct2InterfaceOLinkClient.h"
...
void UTbSame2SameStruct2InterfaceOLinkClient::BroadcastSig1_Implementation(const FTbSame2Struct1& Param1)
{
	Sig1Signal.Broadcast(Param1);
}

FTbSame2SameStruct2InterfaceSig1Delegate& UTbSame2SameStruct2InterfaceOLinkClient::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

void UTbSame2SameStruct2InterfaceOLinkClient::BroadcastSig2_Implementation(const FTbSame2Struct1& Param1, const FTbSame2Struct2& Param2)
{
	Sig2Signal.Broadcast(Param1, Param2);
}

FTbSame2SameStruct2InterfaceSig2Delegate& UTbSame2SameStruct2InterfaceOLinkClient::GetSig2SignalDelegate()
{
	return Sig2Signal;
}

void UTbSame2SameStruct2InterfaceOLinkClient::BroadcastProp1Changed_Implementation(const FTbSame2Struct2& InProp1)
{
	Prop1 = InProp1;
...
FTbSame2SameStruct2InterfaceProp1ChangedDelegate& UTbSame2SameStruct2InterfaceOLinkClient::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}

void UTbSame2SameStruct2InterfaceOLinkClient::BroadcastProp2Changed_Implementation(const FTbSame2Struct2& InProp2)
{
	Prop2 = InProp2;
...
FTbSame2SameStruct2InterfaceProp2ChangedDelegate& UTbSame2SameStruct2InterfaceOLinkClient::GetProp2ChangedDelegate()
{
	return Prop2Changed;
}
...
std::string UTbSame2SameStruct2InterfaceOLinkClient::olinkObjectName()
{
	return "tb.same2.SameStruct2Interface";
}

void UTbSame2SameStruct2InterfaceOLinkClient::olinkOnSignal(std::string name, nlohmann::json args)
{
...
void UTbSame2SameStruct2InterfaceOLinkClient::olinkOnPropertyChanged(std::string name, nlohmann::json value)
{
	std::string path = Name::pathFromName(name);
	applyState({{path, value}});
}

void UTbSame2SameStruct2InterfaceOLinkClient::olinkOnInit(std::string name, nlohmann::json props, IClientNode* node)
{
	m_isReady = true;
	m_node = node;
	applyState(props);
...
void UTbSame2SameStruct2InterfaceOLinkClient::olinkOnRelease()
{
	m_isReady = false;
	m_node = nullptr;
}
