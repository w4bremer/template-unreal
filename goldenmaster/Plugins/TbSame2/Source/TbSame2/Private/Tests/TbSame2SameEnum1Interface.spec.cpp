...
BEGIN_DEFINE_SPEC(UTbSame2SameEnum1InterfaceImplementationSpec, "TbSame2.SameEnum1Interface.Implementation",
...
END_DEFINE_SPEC(UTbSame2SameEnum1InterfaceImplementationSpec);

void UTbSame2SameEnum1InterfaceImplementationSpec::Define()
{
	BeforeEach([this]()
	{
		...
		testImplementation = GameInstanceFixture->GetGameInstance()->GetSubsystem<UTbSame2SameEnum1Interface>();
