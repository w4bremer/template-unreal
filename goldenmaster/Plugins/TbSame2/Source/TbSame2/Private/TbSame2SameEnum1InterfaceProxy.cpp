	...
	, Prop1(ETbSame2Enum1::VALUE1)
{
	...
	BackendService->GetSig1SignalDelegate().AddDynamic(this, &UTbSame2SameEnum1InterfaceProxy::OnSig1);
}

UTbSame2SameEnum1InterfaceProxy::~UTbSame2SameEnum1InterfaceProxy() = default;
