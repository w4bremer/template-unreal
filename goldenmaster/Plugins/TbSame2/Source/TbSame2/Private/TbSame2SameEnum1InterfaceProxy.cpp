	...
	, Prop1(ETbSame2Enum1::VALUE1)
{
	...
	BackendService->GetProp1ChangedDelegate().AddDynamic(this, &UTbSame2SameEnum1InterfaceProxy::BroadcastProp1Changed);
	BackendService->GetSig1SignalDelegate().AddDynamic(this, &UTbSame2SameEnum1InterfaceProxy::BroadcastSig1);
}
...
UTbSame2SameEnum1InterfaceProxy::~UTbSame2SameEnum1InterfaceProxy()
{
	...
	{
		//BackendService->GetProp1ChangedDelegate().RemoveDynamic(this, &UTbSame2SameEnum1InterfaceProxy::BroadcastProp1Changed);
		//BackendService->GetSig1SignalDelegate().RemoveDynamic(this, &UTbSame2SameEnum1InterfaceProxy::BroadcastSig1);
	}
}

void UTbSame2SameEnum1InterfaceProxy::setBackendService(TScriptInterface<ITbSame2SameEnum1InterfaceInterface> InService)
{
...
void UTbSame2SameEnum1InterfaceProxy::BroadcastSig1_Implementation(const ETbSame2Enum1& Param1)
{
...
void UTbSame2SameEnum1InterfaceProxy::BroadcastProp1Changed_Implementation(const ETbSame2Enum1& InProp1)
{
...
void UTbSame2SameEnum1InterfaceProxy::Func1Async_Implementation(UObject* WorldContextObject, FLatentActionInfo LatentInfo, ETbSame2Enum1& Result, const ETbSame2Enum1& Param1)
{
