...
public:
	// signals
	UFUNCTION(Category = "ApiGear|TbSame2|SameEnum2Interface|Signals")
...
protected:
	// signals
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSame2|SameEnum2Interface|Signals", meta = (BlueprintProtected = "true"))
