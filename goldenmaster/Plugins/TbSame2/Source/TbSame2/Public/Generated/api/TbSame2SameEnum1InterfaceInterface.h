...
public:
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "ApiGear|TbSame2|SameEnum1Interface|Signals", DisplayName = "Sig1 Signal")
	FTbSame2SameEnum1InterfaceSig1Delegate OnSig1Signal;

	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "ApiGear|TbSame2|SameEnum1Interface|Signals", DisplayName = "Property Prop1 Changed")
