...
void UTbSame2SameStruct2InterfaceOLinkAdapter::setBackendService(TScriptInterface<ITbSame2SameStruct2InterfaceInterface> InService)
{
	...
	if (BackendService != nullptr)
	{
		...
		BackendSignals->OnProp1ChangedBP.RemoveDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnProp1Changed);
		BackendSignals->OnProp2ChangedBP.RemoveDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnProp2Changed);
		BackendSignals->OnSig1SignalBP.RemoveDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnSig1);
		BackendSignals->OnSig2SignalBP.RemoveDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnSig2);
	}
	...
	BackendSignals->OnProp1ChangedBP.AddDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnProp1Changed);
	BackendSignals->OnProp2ChangedBP.AddDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnProp2Changed);
	BackendSignals->OnSig1SignalBP.AddDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnSig1);
	BackendSignals->OnSig2SignalBP.AddDynamic(this, &UTbSame2SameStruct2InterfaceOLinkAdapter::OnSig2);
