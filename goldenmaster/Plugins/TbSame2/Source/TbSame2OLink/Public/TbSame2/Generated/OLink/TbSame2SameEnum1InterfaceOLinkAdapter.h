...
class TBSAME2OLINK_API UTbSame2SameEnum1InterfaceOLinkAdapter : public UGameInstanceSubsystem
{
	GENERATED_BODY()
public:
	...
	void setBackendService(TScriptInterface<ITbSame2SameEnum1Interface> InService);
