...
class TBSIMPLE_API UTbSimpleSimpleArrayInterfaceOLinkClient : public UObject, public ITbSimpleSimpleArrayInterfaceInterface, public ApiGear::ObjectLink::IObjectSink
{
	GENERATED_BODY()
public:
