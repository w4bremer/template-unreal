...
class FTbSimpleNoOperationsInterfaceLoggingLatentAction : public FPendingLatentAction
{
private:
...
public:
	FTbSimpleNoOperationsInterfaceLoggingLatentAction(const FLatentActionInfo& LatentInfo)
