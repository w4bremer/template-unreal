...
BEGIN_DEFINE_SPEC(UTbSimpleNoSignalsInterfaceImplementationSpec, "TbSimple.NoSignalsInterface.Implementation",
...
END_DEFINE_SPEC(UTbSimpleNoSignalsInterfaceImplementationSpec);

void UTbSimpleNoSignalsInterfaceImplementationSpec::Define()
{
	BeforeEach([this]()
	{
		...
		testImplementation = GameInstanceFixture->GetGameInstance()->GetSubsystem<UTbSimpleNoSignalsInterface>();
