...
public:
	...
	// methods
	UFUNCTION(BlueprintImplementableEvent, Category = "ApiGear|TbSimple|SimpleInterface", meta = (Latent, LatentInfo = "LatentInfo", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"))
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "ApiGear|TbSimple|SimpleInterface")
...
public:
	...
	// methods
	UFUNCTION(BlueprintImplementableEvent, Category = "ApiGear|TbSimple|SimpleArrayInterface", meta = (Latent, LatentInfo = "LatentInfo", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"))
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "ApiGear|TbSimple|SimpleArrayInterface")
