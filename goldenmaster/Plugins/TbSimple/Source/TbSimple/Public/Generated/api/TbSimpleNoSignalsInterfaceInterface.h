...
public:
	...
	UFUNCTION(Category = "ApiGear|TbSimple|NoSignalsInterface|Signals")
...
protected:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|NoSignalsInterface|Signals", meta = (BlueprintProtected = "true"))
