...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	void SetPropInt32(const TArray<int32>& PropInt32);
	virtual void SetPropInt32_Implementation(const TArray<int32>& PropInt32) = 0;
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	TArray<int64> GetPropInt64() const;
	virtual TArray<int64> GetPropInt64_Implementation() const = 0;

	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	void SetPropInt64(const TArray<int64>& PropInt64);
	virtual void SetPropInt64_Implementation(const TArray<int64>& PropInt64) = 0;
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	void SetPropFloat32(const TArray<float>& PropFloat32);
	virtual void SetPropFloat32_Implementation(const TArray<float>& PropFloat32) = 0;
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	TArray<double> GetPropFloat64() const;
	virtual TArray<double> GetPropFloat64_Implementation() const = 0;

	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
	void SetPropFloat64(const TArray<double>& PropFloat64);
	virtual void SetPropFloat64_Implementation(const TArray<double>& PropFloat64) = 0;
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ApiGear|TbSimple|SimpleArrayInterface")
