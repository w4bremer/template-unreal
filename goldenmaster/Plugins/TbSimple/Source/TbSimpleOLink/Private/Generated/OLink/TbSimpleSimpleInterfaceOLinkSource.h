...
/** @brief handles OLink network interactions specific to ITbSimpleSimpleInterface */
...
public:
	...
	void setBackendService(TScriptInterface<ITbSimpleSimpleInterface> InService);
