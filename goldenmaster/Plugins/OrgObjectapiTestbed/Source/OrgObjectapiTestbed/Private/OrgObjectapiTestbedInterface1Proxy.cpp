    ...
    , Prop14(TArray<FOrgObjectapiTestbedStruct1>())
{
    ...
    service->GetProp1ChangedDelegate().AddDynamic(this, &UOrgObjectapiTestbedInterface1Proxy::OnProp1Changed);
...
UOrgObjectapiTestbedInterface1Proxy::~UOrgObjectapiTestbedInterface1Proxy()
{
    service->GetProp1ChangedDelegate().RemoveDynamic(this, &UOrgObjectapiTestbedInterface1Proxy::OnProp1Changed);
...
FOrgObjectapiTestbedInterface1Sig1Delegate& UOrgObjectapiTestbedInterface1Proxy::GetSig1SignalDelegate()
{
    return Sig1Signal;
}
...
FOrgObjectapiTestbedInterface1Sig2Delegate& UOrgObjectapiTestbedInterface1Proxy::GetSig2SignalDelegate()
{
    return Sig2Signal;
}

void UOrgObjectapiTestbedInterface1Proxy::OnSig3(float Step)
{
    OrgObjectapiTestbedInterface1Tracer::trace_signalSig3(Step);
    Sig3Signal.Broadcast(Step);
}

FOrgObjectapiTestbedInterface1Sig3Delegate& UOrgObjectapiTestbedInterface1Proxy::GetSig3SignalDelegate()
{
    return Sig3Signal;
}

void UOrgObjectapiTestbedInterface1Proxy::OnProp1Changed(bool bInProp1)
{
    OrgObjectapiTestbedInterface1Tracer::capture_state(this);
    Prop1Changed.Broadcast(bInProp1);
}
...
FOrgObjectapiTestbedInterface1Prop1ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp1ChangedDelegate()
{
    return Prop1Changed;
}
...
FOrgObjectapiTestbedInterface1Prop2ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp2ChangedDelegate()
{
    return Prop2Changed;
}
...
FOrgObjectapiTestbedInterface1Prop3ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp3ChangedDelegate()
{
    return Prop3Changed;
}
...
FOrgObjectapiTestbedInterface1Prop4ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp4ChangedDelegate()
{
    return Prop4Changed;
}
...
FOrgObjectapiTestbedInterface1Prop5ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp5ChangedDelegate()
{
    return Prop5Changed;
}

void UOrgObjectapiTestbedInterface1Proxy::OnProp6Changed(const FOrgObjectapiTestbedStruct1& InProp6)
{
    OrgObjectapiTestbedInterface1Tracer::capture_state(this);
...
FOrgObjectapiTestbedInterface1Prop6ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp6ChangedDelegate()
{
    return Prop6Changed;
}
...
FOrgObjectapiTestbedInterface1Prop7ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp7ChangedDelegate()
{
    return Prop7Changed;
}
...
FOrgObjectapiTestbedInterface1Prop10ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp10ChangedDelegate()
{
    return Prop10Changed;
}

void UOrgObjectapiTestbedInterface1Proxy::OnProp11Changed(const TArray<FOrgObjectapiTestbedStruct1>& InProp11)
{
    OrgObjectapiTestbedInterface1Tracer::capture_state(this);
...
FOrgObjectapiTestbedInterface1Prop11ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp11ChangedDelegate()
{
    return Prop11Changed;
}

void UOrgObjectapiTestbedInterface1Proxy::OnProp12Changed(const TArray<EOrgObjectapiTestbedEnum1>& InProp12)
{
    OrgObjectapiTestbedInterface1Tracer::capture_state(this);
...
FOrgObjectapiTestbedInterface1Prop12ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp12ChangedDelegate()
{
    return Prop12Changed;
}

void UOrgObjectapiTestbedInterface1Proxy::OnProp14Changed(const TArray<FOrgObjectapiTestbedStruct1>& InProp14)
{
    OrgObjectapiTestbedInterface1Tracer::capture_state(this);
...
FOrgObjectapiTestbedInterface1Prop14ChangedDelegate& UOrgObjectapiTestbedInterface1Proxy::GetProp14ChangedDelegate()
{
