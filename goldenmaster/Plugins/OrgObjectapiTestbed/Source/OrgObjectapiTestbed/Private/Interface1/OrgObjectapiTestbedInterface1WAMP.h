...
class OrgObjectapiTestbedInterface1WAMPService : public AbstractOrgObjectapiTestbedInterface1Publisher
{
public:

    explicit OrgObjectapiTestbedInterface1WAMPService();
    virtual ~OrgObjectapiTestbedInterface1WAMPService();
