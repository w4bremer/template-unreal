...
#include "TbEnumEnumInterfaceSimulationClient.h"
...
void UTbEnumEnumInterfaceSimulationClient::BroadcastSig0_Implementation(const ETbEnumEnum0& Param0)
{
	Sig0Signal.Broadcast(Param0);
}

FTbEnumEnumInterfaceSig0Delegate& UTbEnumEnumInterfaceSimulationClient::GetSig0SignalDelegate()
{
	return Sig0Signal;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastSig1_Implementation(const ETbEnumEnum1& Param1)
{
	Sig1Signal.Broadcast(Param1);
}

FTbEnumEnumInterfaceSig1Delegate& UTbEnumEnumInterfaceSimulationClient::GetSig1SignalDelegate()
{
	return Sig1Signal;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastSig2_Implementation(const ETbEnumEnum2& Param2)
{
	Sig2Signal.Broadcast(Param2);
}

FTbEnumEnumInterfaceSig2Delegate& UTbEnumEnumInterfaceSimulationClient::GetSig2SignalDelegate()
{
	return Sig2Signal;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastSig3_Implementation(const ETbEnumEnum3& Param3)
{
	Sig3Signal.Broadcast(Param3);
}

FTbEnumEnumInterfaceSig3Delegate& UTbEnumEnumInterfaceSimulationClient::GetSig3SignalDelegate()
{
	return Sig3Signal;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastProp0Changed_Implementation(const ETbEnumEnum0& InProp0)
{
	Prop0 = InProp0;
	Prop0Changed.Broadcast(InProp0);
}

ETbEnumEnum0 UTbEnumEnumInterfaceSimulationClient::GetProp0_Implementation() const
{
	return Prop0;
}

void UTbEnumEnumInterfaceSimulationClient::SetProp0_Implementation(const ETbEnumEnum0& InProp0)
{
	Params params;
...
FTbEnumEnumInterfaceProp0ChangedDelegate& UTbEnumEnumInterfaceSimulationClient::GetProp0ChangedDelegate()
{
	return Prop0Changed;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastProp1Changed_Implementation(const ETbEnumEnum1& InProp1)
{
	Prop1 = InProp1;
	Prop1Changed.Broadcast(InProp1);
}

ETbEnumEnum1 UTbEnumEnumInterfaceSimulationClient::GetProp1_Implementation() const
{
	return Prop1;
}

void UTbEnumEnumInterfaceSimulationClient::SetProp1_Implementation(const ETbEnumEnum1& InProp1)
{
	Params params;
...
FTbEnumEnumInterfaceProp1ChangedDelegate& UTbEnumEnumInterfaceSimulationClient::GetProp1ChangedDelegate()
{
	return Prop1Changed;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastProp2Changed_Implementation(const ETbEnumEnum2& InProp2)
{
	Prop2 = InProp2;
	Prop2Changed.Broadcast(InProp2);
}

ETbEnumEnum2 UTbEnumEnumInterfaceSimulationClient::GetProp2_Implementation() const
{
	return Prop2;
}

void UTbEnumEnumInterfaceSimulationClient::SetProp2_Implementation(const ETbEnumEnum2& InProp2)
{
	Params params;
...
FTbEnumEnumInterfaceProp2ChangedDelegate& UTbEnumEnumInterfaceSimulationClient::GetProp2ChangedDelegate()
{
	return Prop2Changed;
}

void UTbEnumEnumInterfaceSimulationClient::BroadcastProp3Changed_Implementation(const ETbEnumEnum3& InProp3)
{
	Prop3 = InProp3;
	Prop3Changed.Broadcast(InProp3);
}

ETbEnumEnum3 UTbEnumEnumInterfaceSimulationClient::GetProp3_Implementation() const
{
	return Prop3;
}

void UTbEnumEnumInterfaceSimulationClient::SetProp3_Implementation(const ETbEnumEnum3& InProp3)
{
	Params params;
...
FTbEnumEnumInterfaceProp3ChangedDelegate& UTbEnumEnumInterfaceSimulationClient::GetProp3ChangedDelegate()
{
	return Prop3Changed;
}

ETbEnumEnum0 UTbEnumEnumInterfaceSimulationClient::Func0_Implementation(const ETbEnumEnum0& Param0)
{
	Params params;
...
ETbEnumEnum1 UTbEnumEnumInterfaceSimulationClient::Func1_Implementation(const ETbEnumEnum1& Param1)
{
	Params params;
...
ETbEnumEnum2 UTbEnumEnumInterfaceSimulationClient::Func2_Implementation(const ETbEnumEnum2& Param2)
{
	Params params;
...
ETbEnumEnum3 UTbEnumEnumInterfaceSimulationClient::Func3_Implementation(const ETbEnumEnum3& Param3)
{
	Params params;
